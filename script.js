...
var map = L.map("map", {
  ...
  center: [21.028511, 105.8542], // Tọa độ của Hà Nội, Việt Nam
  zoom: 10,
  editable: true,
...
$(".leaflet-control-layers-separator").after(
  "<br><strong class='title'>Layers</strong><br>"
);
      ...
      layer.on({
        ...
        click: function (e) {
          if (layer.options.color == "#FFFF00") {
            ...
            console.log(
              "deselected " + e.target.feature.properties.description
            );
          } else {
            //Do Select
            layer.setStyle({
...
function setSelectedLayers() {
  ...
  $.each(map._layers, function (ml) {
    if (
      ...
      map._layers[ml].feature.properties.selected === true
    ) {
...
function getSelectedLayers() {
  $.each(selectedFeatureName, function (ml) {
    if (
      selectedFeatureName[ml].feature &&
      selectedFeatureName[ml].feature.properties.selected === true
    ) {
...
function initDrawSaveButton() {
  var saveFileElem =
    '<a class="leaflet-draw-edit-edit leaflet-disabled" href="javascript:ExportGeoJSON();" id="ExportGeoJSON" title="No layers to Save"><span class="sr-only">Save layers to file</span></a>';
  $(
    "#map > div.leaflet-control-container > div.leaflet-top.leaflet-left > div.leaflet-draw.leaflet-control > div:nth-child(2) > div"
  ).append(saveFileElem);
}
...
function ExportGeoJSON() {
  if ($(".leaflet-draw-edit-edit").hasClass("leaflet-disabled")) {
    ...
    var convertedData = new Blob([JSON.stringify(data)], {
